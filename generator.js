Generate = function() {
    minWordLen = document.querySelector('#minwordlen').value;
    maxWordLen = document.querySelector('#maxwordlen').value;
    maxLen = document.querySelector('#maxlength').value;
    easyType = document.querySelector('#EasyType').checked;
    numberSub = document.querySelector('#NumberSub').checked;
    var list = ["the",
    "of",
    "to",
    "and",
